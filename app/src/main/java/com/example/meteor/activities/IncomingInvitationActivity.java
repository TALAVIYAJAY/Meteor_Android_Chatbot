...
public class IncomingInvitationActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        super.onStart();
        Toast.makeText(IncomingInvitationActivity.this,  "IA 166", Toast.LENGTH_SHORT).show();
    ...
    protected void onStop() {
        Toast.makeText(IncomingInvitationActivity.this,  "IA 175", Toast.LENGTH_SHORT).show();
        super.onStop();
