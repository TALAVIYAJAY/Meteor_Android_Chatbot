...
import com.example.meteor.network.ApiClient;
import com.example.meteor.network.ApiService;
...
public class OutgoingInvitationActivity extends AppCompatActivity {
    ...
    private void initiateMeeting(String meetingType, String receiverToken, ArrayList<User> receivers) {
        try {
            ...
            Toast.makeText(this,  "OA 161", Toast.LENGTH_SHORT).show();
            finish();
        }
    }
            ...
            if (type != null) {
                if (type.equals(Constants.REMOTE_MSG_INVITATION_ACCEPTED)) {
                    ...
                    try {
                        ...
                        Toast.makeText(OutgoingInvitationActivity.this,  "OA 250", Toast.LENGTH_SHORT).show();
                        finish();
                    }
    ...
    protected void onStart() {
        super.onStart();
        Toast.makeText(OutgoingInvitationActivity.this,  "OA 266", Toast.LENGTH_SHORT).show();
    ...
    protected void onStop() {
        super.onStop();
        Toast.makeText(OutgoingInvitationActivity.this,  "OA 276", Toast.LENGTH_SHORT).show();
